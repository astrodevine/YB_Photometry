...
out_name = path+ 'YBphotometry_results_MWPradius_25padded.csv'
#######################################################
...
#Make the plots pretty 
    ...
    figurename=path+'photom_images_MWPradius_padded/'+um+'interpolation_YB_%s.png' %(YB)
...
class do_interp():
        def __init__(self, img, radius):
            ...
            radius=int(radius+oradius/3)
            #use the radius to create a NaN mask      
            xmin = 50-radius-5
            xmax = 50+radius+5
            ymin = 50-radius-5
            ymax = 50+radius+5
            ...
            cv2.circle(mask, (50,50), radius, 255, -1)          
...
if os.path.exists(out_name):
    ...
    headers = ['YB', 'YB_long', 'YB_lat','8umphotom','8cin', '8flag1', '8flag2',
    ...
    writer=csv.DictWriter(output_file,fieldnames=['YB','YB_long','YB_lat','8umphotom','8cin', '8flag1', 
    ...
    writer.writeheader()
    writer.writerow({'YB':'ID Number','YB_long':'degree','YB_lat':'degree','8umphotom':'Jy', 
...
for k in range (YB1,YB2):    
    ...
    while check != 'n':
        ...
        interp24 = do_interp(workmask24, YB_rad_pix)
    ...
    while check != 'n':
        ...
        #do the masking and interpolation on 8um image
        interp12 = do_interp(workmask12, YB_rad_pix)
...
#    flag12 = make_flags(workmask12, interp12.resid, '12')
    ...
    while check != 'n':       
        ...
        #do the masking and interpolation on 8um image
        interp8 = do_interp(workmask, YB_rad_pix)
        diff8=interp8.resid
        #calculate the compactness index
